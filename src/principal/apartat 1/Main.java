    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while ((strLinia = bfLector.readLine()) != null) {
                ...
                String provincia = strLinia.substring(12, 13);
                String candidatura = strLinia.substring(15,20);
                String vots = strLinia.substring(21,28);
                String candidats_obtinguts = strLinia.substring(29,33);

                int provincia_id = Integer.parseInt(provincia);
                int candidatura_id = Integer.parseInt(candidatura);
                int numVots = Integer.parseInt(vots);
                int numCandidats_obtinguts = Integer.parseInt(candidats_obtinguts);
